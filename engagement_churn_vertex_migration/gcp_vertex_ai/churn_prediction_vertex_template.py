"""
GCP Vertex AI template equivalent for Churn Prediction model.
"""
...
@dataclass
class ChurnPredictionVertexConfig:
    project_id: str
    region: str
    staging_bucket: str
...
class ChurnPredictionVertexTemplate:
    def __init__(self, config: ChurnPredictionVertexConfig):
        self.config = config
        self.model = None
        self.endpoint = None
        aiplatform.init(
